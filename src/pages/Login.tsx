  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cream py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-nature-200 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
        <div className="absolute top-40 -right-40 w-96 h-96 bg-earth-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
      </div>
      ...
      <motion.div
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Sign in to your NatureBloom account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <a
                href="#"
                className="text-xs font-medium text-nature-600 hover:text-nature-700">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3.5 bg-nature-600 text-white rounded-xl font-medium hover:bg-nature-700 transition-colors shadow-soft hover:shadow-soft-lg flex items-center justify-center gap-2 mt-2">
